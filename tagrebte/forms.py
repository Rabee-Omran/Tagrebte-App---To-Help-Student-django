...
from tagrebte.models import Comment, Post, PostType, Profile
...
class PostCreateForm(forms.ModelForm):
    content = forms.CharField(label=' تجربتك / استفسارك  ', widget=forms.Textarea)
    mytype = forms.ChoiceField(label='النوع',choices=POST_TYPE)
    class Meta:
        model = Post
        fields = [ 'mytype','content']
